                            ...
                            <div class="right-side">
                                ...
                                <div class="row footer-links">
                                    ...
                                    <div class="col-md-3 col-sm-6 sub-two-right mt-5">
                                        <h6>Locations</h6>
                                        <ul>
                                            <li><a href="genre.html">Pune</a></li>
                                            <li><a href="genre.html">Mumbai</a></li>
                                            <li><a href="genre.html">Thane</a></li>
                                            <li><a href="genre.html">Kolhapur</a></li>
                                            <li><a href="genre.html">Nashik</a></li>
                                            <li><a href="genre.html">Bengluru</a></li>
                                        </ul>
                                    </div>
                                    <div class="col-md-3 col-sm-6 sub-two-right mt-5">
                                        <h6>Newsletter</h6>
